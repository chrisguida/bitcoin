...
RDTS activates for blocks whose own nTime lies in [hardforktime, rdtsexpiry).
...
# RDTS flag day; only the RDTS rules flip at FORK_TIME (this branch carries no
# PoW-change machinery). Effectively-permanent expiry.
...
class ReducedDataUTXOHeightTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        Key validations:
        • RDTS active for blocks with nTime in [hardforktime, rdtsexpiry)
