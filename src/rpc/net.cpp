...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        "Add the address of a potential peer to an address manager table. This RPC is for testing only.",
        {
            ...
            {"services", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "Service flags to advertise for the address (default: NODE_NETWORK | NODE_WITNESS | NODE_BLAKE2B)"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const ServiceFlags services{request.params[3].isNull() ? ServiceFlags{NODE_NETWORK | NODE_WITNESS | NODE_BLAKE2B} : static_cast<ServiceFlags>(request.params[3].getInt<uint64_t>())};
